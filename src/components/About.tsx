    ...
    <Section about="about" background="light">
      ...
      <div className="about-section">
        <div className="about-box about-box-dark">
          <h3>Who am I?</h3>
          <p>
            My name is <span className="about-word-highlight">Xander</span>, a
            (very) amateur baker from the UK. I've been baking (and cooking,
            steaming, frying....) my way through traditional dessert recipes
            from the world's island countries.
          </p>
        </div>
